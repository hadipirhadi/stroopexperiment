...
expName = 'آزمون آنلاین استروپ استاندارد'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\pythonproject\\stroopexperiment\\stroopExperiment_Online_lastrun.py',
